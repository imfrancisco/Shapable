...
public class ShapesLevel2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shapes_level2);
        ...
        mySong =  MediaPlayer.create(ShapesLevel2.this, R.raw.lostjungle);
        mySong.start();

        findViewById(R.id.button_circle).setOnLongClickListener(mStrtDrg);
        findViewById(R.id.button_hexagon).setOnLongClickListener(mStrtDrg);
        ...
        findViewById(R.id.button_rectangle).setOnLongClickListener(mStrtDrg);
        findViewById(R.id.button_oval).setOnLongClickListener(mStrtDrg);

        findViewById(R.id.button_answer_hexagon).setOnDragListener(mEndDrg);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ShapesLevel2.this,CardViewGames.class);
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //reset score to zero
                Toast.makeText(ShapesLevel2.this, "Reset", Toast.LENGTH_SHORT).show();
        ...
        String score = sharedPreferences_shapes_Level2.getString(KEY_SCORE_SHAPE_LEVEL2,null);
        if(score != null){
            Intent intent = new Intent(ShapesLevel2.this,ParentPortal.class);
            startActivity(intent);
        }
    }
        ...
        public boolean onDrag(View v, DragEvent event) {
            if(event.getAction()==DragEvent.ACTION_DROP){
                ...
                if((tagDropTarget!=null)&& tagDropTarget.equals(tagDroppedImage)){
                    ...
                    score.setText("Score: "+mscore);
                    Toast.makeText(ShapesLevel2.this, "Your total Score is " + mscore, Toast.LENGTH_LONG).show();
                    tap.setVisibility(View.VISIBLE);

                    SharedPreferences.Editor editor = sharedPreferences_shapes_Level2.edit();
                    editor.putString(KEY_SCORE_SHAPE_LEVEL2,score.getText().toString());
                    editor.apply();
