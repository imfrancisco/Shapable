...
public class SeaWorldLevel2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sea_world_level2);
        ButterKnife.bind(this);
        mStrtDrg = new MyStrtDrggngLstnr();
        mEndDrg = new MyEndDrgLstnr();
        soundPlayer = new SoundPlayer(this);

        mySong =  MediaPlayer.create(SeaWorldLevel2.this, R.raw.lostjungle);
        mySong.start();

        findViewById(R.id.button_dolphin).setOnLongClickListener(mStrtDrg);
        ...
        findViewById(R.id.button_fish).setOnLongClickListener(mStrtDrg);
        findViewById(R.id.button_whale).setOnLongClickListener(mStrtDrg);


        findViewById(R.id.button_answer_lobster).setOnDragListener(mEndDrg);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SeaWorldLevel2.this,CardViewGames.class);
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //reset score to zero
                Toast.makeText(SeaWorldLevel2.this, "Reset", Toast.LENGTH_SHORT).show();
        ...
        String score = sharedPreferences_seaWorld_Level2.getString(KEY_SCORE_SEAWORLD_LEVEL2,null);
        if(score != null){
            Intent intent = new Intent(SeaWorldLevel2.this,ParentPortal.class);
            startActivity(intent);
        }
    }
        ...
        public boolean onDrag(View v, DragEvent event) {
            if(event.getAction()==DragEvent.ACTION_DROP){
                ...
                if((tagDropTarget!=null)&& tagDropTarget.equals(tagDroppedImage)){
                    ...
                    score.setText("Score: "+mscore);
                    Toast.makeText(SeaWorldLevel2.this, "Your total Score is " + mscore, Toast.LENGTH_LONG).show();
                    tap.setVisibility(View.VISIBLE);

                    SharedPreferences.Editor editor = sharedPreferences_seaWorld_Level2.edit();
                    editor.putString(KEY_SCORE_SEAWORLD_LEVEL2,score.getText().toString());
                    editor.apply();
